...
/**
 * Whether an omnipresence id is in a per-world allow-list. A falsy id or a
 * missing/non-array list is never selected. Foundry-independent.
 * @returns {boolean}
 */
export function isSelected(id, allowList) {
  if (!id) return false;
